...
<script type="text/javascript">
	function myclose(page) {
		//window.location="${pageContext.request.contextPath}/prod/product.action?flag=split&page="+page;
		window.location="${pageContext.request.contextPath}/prod/split.action?page="+page;
		//window.close();
	}
</script>
			<div id="table">
